...
var _GameBox = __webpack_require__(59);

var _GameBox2 = _interopRequireDefault(_GameBox);

var _GameBoxSelected = __webpack_require__(60);

var _GameBoxSelected2 = _interopRequireDefault(_GameBoxSelected);
...
var Footer = function (_React$Component) {
  ...
  function Footer() {
    ...
    _this.onChangeGame = _this.onChangeGame.bind(_this);
    return _this;
  }
  ...
  _createClass(Footer, [{
    ...
    value: function componentDidMount() {
      ...
      _axios2.default.get('https://my-json-server.typicode.com/fanduel/moneyball-fe-challenge-data/footer_scoreboard').then(function (res) {
        return res.data;
      }).then(function (scores) {
        return _this2.setState({ scores: scores, selectedGame: scores[0] });
      });
    }
  }, {
    key: 'onChangeGame',
    value: function onChangeGame(id) {
      var scores = this.state.scores;

      var selectedGame = scores.find(function (game) {
    ...
    value: function render() {
      ...
      var onChangeGame = this.onChangeGame;

      return _react2.default.createElement(_Footer, _extends({}, this.props, { scores: scores, onChangeGame: onChangeGame, selectedGame: selectedGame }));
    }
  }]);
...
var _Footer = function _Footer(_ref) {
  var scores = _ref.scores,
      selectedGame = _ref.selectedGame,
      onChangeGame = _ref.onChangeGame;

  var otherGames = scores.filter(function (score) {
    return score.game_id !== selectedGame.game_id;
  });
  return _react2.default.createElement(
    ...
    scores.map(function (game) {
      return game.game_id === selectedGame.game_id ? _react2.default.createElement(_GameBoxSelected2.default, { key: game.game_id, selectedGame: selectedGame }) : _react2.default.createElement(
        ...
        _react2.default.createElement(_GameBox2.default, { game: game })
      );
    }),
    _react2.default.createElement('div', { className: 'arrow-divider' }),
    _react2.default.createElement(
      'div',
      { className: 'arrow' },
      '>'
...
var FooterPlayerStats = function FooterPlayerStats(_ref) {
  var topPerformer = _ref.topPerformer;
  var team = topPerformer.team,
      name = topPerformer.name,
      points = topPerformer.points,
      position = topPerformer.position,
      rebounds = topPerformer.rebounds;
...
exports.default = FooterPlayerStats;
...
*/
var ba=__webpack_require__(3),ea=__webpack_require__(0),m=__webpack_require__(11),A=__webpack_require__(5),C=__webpack_require__(4),fa=__webpack_require__(12),ha=__webpack_require__(13),ja=__webpack_require__(14),ka=__webpack_require__(6);
...
var _Scoreboard = __webpack_require__(55);

var _Scoreboard2 = _interopRequireDefault(_Scoreboard);

var _PlayByPlay = __webpack_require__(56);

var _PlayByPlay2 = _interopRequireDefault(_PlayByPlay);

var _Stats = __webpack_require__(57);

var _Stats2 = _interopRequireDefault(_Stats);

var _YourScoring = __webpack_require__(58);
...
var Nav = function (_React$Component) {
  ...
  _createClass(Nav, [{
    ...
    value: function componentDidMount() {
      ...
      _axios2.default.get('https://my-json-server.typicode.com/fanduel/moneyball-fe-challenge-data/nav_elements').then(function (res) {
        return res.data;
      }).then(function (nav) {
        return _this2.setState({ nav: nav });
      });
    }
  }, {
    key: 'render',
...
var Scoreboard = function (_React$Component) {
  ...
  _createClass(Scoreboard, [{
    ...
    value: function componentDidMount() {
      ...
      _axios2.default.get('https://my-json-server.typicode.com/fanduel/moneyball-fe-challenge-data/game_stats').then(function (res) {
        return res.data;
      }).then(function (game_stats) {
        return _this2.setState({ game_stats: game_stats });
      });
    }
  }, {
    key: 'render',
...
var PlayByPlay = function (_React$Component) {
  _inherits(PlayByPlay, _React$Component);

  function PlayByPlay() {
    _classCallCheck(this, PlayByPlay);

    var _this = _possibleConstructorReturn(this, (PlayByPlay.__proto__ || Object.getPrototypeOf(PlayByPlay)).call(this));
  ...
  _createClass(PlayByPlay, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this2 = this;

      _axios2.default.get('https://my-json-server.typicode.com/fanduel/moneyball-fe-challenge-data/db').then(function (res) {
        return res.data;
      }).then(function (info) {
        _this2.setState({ plays: info.plays, homeTeam: info.game_stats.home_team, awayTeam: info.game_stats.away_team });
      });
    }
  }, {
    key: 'render',
...
var _FooterPlayerStats = __webpack_require__(21);

var _FooterPlayerStats2 = _interopRequireDefault(_FooterPlayerStats);
...
var GameBox = function GameBox(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      { className: 'footer-box-team-score' },
      _react2.default.createElement(
        'div',
        { className: 'footer-box-team' },
        away_team.abbrev
      ),
      _react2.default.createElement(
        'div',
        { className: 'footer-box-score' },
        away_team.score
      )
    ),
    _react2.default.createElement(
...
var GameBoxSelected = function GameBoxSelected(_ref) {
  var selectedGame = _ref.selectedGame;

  if (!selectedGame.quarter) return null;
  var away_team = selectedGame.away_team,
      home_team = selectedGame.home_team,
      time_left = selectedGame.time_left,
      quarter = selectedGame.quarter,
      top_performers = selectedGame.top_performers;

  return _react2.default.createElement(
    'div',
    { className: 'big-game-box' },
    _react2.default.createElement(
      'div',
      { className: 'footer-box-select' },
      _react2.default.createElement(
        'div',
        { className: 'footer-box-team-score' },
        _react2.default.createElement(
    ...
    _react2.default.createElement(_FooterPlayerStats2.default, { topPerformer: top_performers[1] }),
    _react2.default.createElement(_FooterPlayerStats2.default, { topPerformer: top_performers[0] })
  );
}; /* eslint-disable */
exports.default = GameBoxSelected;
